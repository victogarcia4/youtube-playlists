...
const playlists = [
  ...
  },
  {
    ...
    kicker: "Juan Luis Guerra",
    description:
      "A curated run of Juan Luis Guerra's most beloved songs, from merengue and bachata to his signature poetic storytelling.",
    tone: "Romantic, rhythmic, warm",
    duration: "Guerra essentials",
    accent: "#c0392b",
    url: "https://www.youtube.com/watch?v=WCzEer78cgE",
  },
];
